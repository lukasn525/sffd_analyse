...
Fairnesspruefung - haengt die Prognoseguete am Sozialprofil der Teststadtteile?
    ...
    python modelle/fairness.py

Ausgang: results/fairness/fairness.csv, results/fairness/fairness.md

TEIL DER ABGABE - seit dem 11.09.2026 in modelle/ (vorher tools/).
Abschnitt 8.3 beruft sich auf die erzeugten Dateien.
...
def main() -> int:
    ...
    t = ["# Fairness der Prognoseguete", "",
         "Erzeugt von `modelle/fairness.py`. Je Verfahren und Zielgroesse "
