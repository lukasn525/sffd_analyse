"""
Eignungspruefung: Passen Ridge Regression, Random Forest und XGBoost zu diesem
Datensatz?

Dieser Schritt schaetzt kein Modell und bewertet keines. Er prueft die
VORAUSSETZUNGEN der drei Verfahren gegen die fertigen Datensaetze und faellt am
Ende ein explizites Urteil je Verfahren (Abschnitt 9). Damit ist vor der
...
lineares Regressionsmodell verwenden" -> Linearitaetspruefung explizit,
Abschnitt 5.
...
vollstaendig vor dem End-Hold-out. Damit beruht keine Verfahrensentscheidung auf
Beobachtungen, die spaeter zur Bewertung dienen. Rein deskriptive Kennzahlen
...
bericht: list[str] = []
# Sammelt die maschinell gepruefeten Kriterien fuer das Urteil in Abschnitt 9:
