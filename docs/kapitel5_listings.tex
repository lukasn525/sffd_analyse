...
\begin{lstlisting}[style=pythonstil,
  ...
  caption={Zeitbewusste Zuordnung des ACS-Jahrgangs.
           Quelle: \texttt{prep/s1\_daten.py}, Z.~306--322 und 337, gekürzt}]
...
\begin{lstlisting}[style=pythonstil,
  label={lst:quoten},
  caption={Anteilswerte aus Zählvariablen; ein Nenner von null ergibt einen
           fehlenden Wert statt einer Division durch null.
           Quelle: \texttt{prep/s1\_daten.py}, Z.~559--584, gekürzt}]
QUOTEN = [
...
\begin{lstlisting}[style=pythonstil,
  label={lst:lags},
  caption={Verlaufsmerkmale, strikt rückwärtsgerichtet und je Stadtteil gebildet.
           Quelle: \texttt{prep/s2\_datensaetze.py}, Z.~269--283, gekürzt}]
...
\begin{lstlisting}[style=pythonstil,
  ...
  caption={Vereinheitlichung auf modelltaugliche NumPy-Typen.
           Quelle: \texttt{prep/s2\_datensaetze.py}, Z.~147--170, gekürzt}]
...
\begin{lstlisting}[style=pythonstil,
  label={lst:folds},
  caption={Zuteilung der Stadtteile auf Folds und Hold-out mit doppelter
           Stratifizierung.
           Quelle: \texttt{prep/s2\_datensaetze.py}, Z.~61--89, gekürzt}]
...
\begin{lstlisting}[style=pythonstil,
  label={lst:poisson},
  caption={Stufe-2-Baseline: Poisson-GLM mit \texttt{log}-Link und
           Bevölkerung als Offset.
           Quelle: \texttt{vorpruefung/v1\_baselines.py}, Z.~74--104, gekürzt}]
...
\begin{lstlisting}[style=pythonstil,
  ...
  caption={Zwei der neunzehn Prüfungen an den erzeugten Dateien.
           Quelle: \texttt{tests/test\_aufbereitung.py}, Z.~255--260 und
           277--285, gekürzt}]
